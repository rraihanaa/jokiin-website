            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if($projectApplicant->project->has_finished)
                    <span class="text-white font-bold bg-green-500 rounded-2xl w-full p-5">
                        Tugas telah selesai, Fee sudah diberikan kepada Penjoki
                    </span>
                @endif
                ...
                <div class="flex flex-row items-center justify-between">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">{{$projectApplicant->penjoki->name}}</h3>
                            <p class="text-slate-500 text-sm">{{$projectApplicant->penjoki->occupation}}</p>
                        </div>
                    </div>
                ...
                <h3 class="text-indigo-950 text-xl font-bold mt-5">Pesan</h3>
                <p>
                ...
                @if($projectApplicant->status == 'Diterima')
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold">Hubungi Penjoki Sekarang!</h3>
                ...
                <p class="text-indigo-950 text-lg font-bold">{{$projectApplicant->penjoki->email}}</p>
                ...
                {{-- <form method="POST" action="{{route('admin.reply_applicant.update', $projectApplicant->id)}}" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="mt-2 w-full font-bold py-4 px-6 bg-blue-500 text-white rounded-full">
                        Terima Pengajuan Joki
                    </button>
                </form> --}}
