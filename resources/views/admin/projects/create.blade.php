    ...
    <div class="max-w-4xl mt-10 mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
            <span class="text-white font-bold bg-red-500 rounded-2xl w-fit p-5">
                Pastikan saldo kamu cukup sesuai budget tugas yang kamu tentukan
            </span>
            <div class="flex flex-row justify-between items-center">
                ...
                <a href="{{route('dashboard.wallet.topup')}}" class="font-bold py-4 px-6 bg-blue-500 text-white rounded-full">
                    Top Up Saldo
                </a>
            </div>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.projects.store')}}" enctype="multipart/form-data">
                    ...
                    <div>
                        <x-input-label for="name" :value="__('Judul Tugas')" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="skill_level" :value="__('Level Kesulitan')" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="deadline" id="deadline" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            <option value="">Tentukan Deadline</option>
                            <option value="1-3 Hari">1-3 Hari</option>
                            <option value="< 3 Minggu">1-4 Minggu</option>
                            <option value="> 1 bulan">1 bulan atau lebih</option>
                        </select>
