        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">
                    {{$walletTransaction->type === 'Topup' ? 'Detail Top Up' : 'Detail Penarikan'}}
                </h3>
                ...
                @if($walletTransaction->type == 'Penarikan')
                <hr class="my-5">
                    ...
                    @if(!$walletTransaction->is_paid)
                    <h3 class="text-indigo-950 text-xl font-bold">Konfirmasi Penarikan Dana</h3>
                ...
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">Bukti Transfer</h3>
                        <img src="{{Storage::url($walletTransaction->proof)}}" alt="" class="rounded-2xl object-cover w-[300px] h-[500px] mb-3">
