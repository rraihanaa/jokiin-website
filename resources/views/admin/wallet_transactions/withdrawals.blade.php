                ...
                @forelse($withdrawals_transactions as $transaction)
                    <div class="item-card flex flex-row justify-between items-center">
                        ...
                        <div class="hidden md:flex flex-row items-center gap-x-3">
                            <a href="{{route('admin.wallet_transactions.show', $transaction)}}" class="font-bold py-4 px-6 bg-blue-500 text-white rounded-full">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
                    @empty
                    <p>
                        Belum ada transaksi penarikan dana terbaru
                    </p>
                    @endforelse
