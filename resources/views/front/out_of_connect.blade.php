...
<body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
    ...
    <div class="empty-state flex flex-col flex-1 items-center justify-center mx-auto gap-[50px] sm:min-h-[calc(100vh-212px)] max-sm:mt-[132px]">
        ...
        <div class="flex flex-col gap-[6px] text-center w-[345px]">
            <p class="font-bold text-xl leading-[30px]">Pensil Kamu Tidak Cukup :(</p>
            <p class="text-sm leading-[28px]">Pensil yang kamu miliki telah habis sehingga proses pengajuan joki tidak berhasil</p>
        </div>
        <div class="flex items-center w-[380px] gap-3 text-center">
            <a href="" class="p-[14px_20px] rounded-full bg-[#030303] font-semibold text-white w-full">Hubungi CS Kami</a>
            <a href="" class="p-[14px_20px] rounded-full bg-[#545768] font-semibold text-white w-full">Topup Pensil</a>
        </div>
    </div>
