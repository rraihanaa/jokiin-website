    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-row gap-x-5 items-center">
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">Total Saldo</p>
                ...
                <div>
                    <h3 class="text-indigo-950 text-xl font-bold mb-5">Kirimkan kepada:</h3>
            <div class="flex flex-row gap-x-10">    
                <div>
                    <p class="text-slate-500 text-sm">Bank</p>
                    <h3 class="text-indigo-950 text-xl font-bold">Bank Joki</h3>
                </div>
                <div>
                    <p class="text-slate-500 text-sm">Nomor Rekening</p>
                    <h3 class="text-indigo-950 text-xl font-bold">1234567890</h3>
                </div>
                <div>
                    <p class="text-slate-500 text-sm">Nama Pemilik Rekening</p>
                    <h3 class="text-indigo-950 text-xl font-bold">Jokiin Tugas</h3>
                </div> 
            </div>
                ...
                <h3 class="text-indigo-950 text-xl font-bold">Konfirmasi Top Up Saldo</h3>
                <form method="POST" action="{{route('dashboard.wallet.topup.store')}}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="amout" class="block mt-1 w-full" type="text" name="amount" :value="old('amount')" required autofocus autocomplete="amount" />
                        <x-input-error :messages="$errors->get('amount')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="proof" :value="__('Bukti Transfer')" />
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit" class="font-bold py-4 px-6 bg-blue-500 text-white rounded-full">
                            Konfirmasi Top Up
                        </button>
                    </div>
                </form>
