            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between items-center">
                    ...
                    <div class="flex flex-row gap-x-5">
                        ...
                        <a href="{{route('dashboard.wallet.withdraw')}}" class="font-bold py-4 px-6 bg-blue-500 text-white rounded-full">
                ...
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold">Riwayat Transaksi</h3>
                ...
                <div class="flex flex-row  justify-between items-center">
                    ...
                    <div class="">
                        <p class="text-slate-500 text-sm">Tipe</p>
