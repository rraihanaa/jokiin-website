        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <span class="text-white font-bold bg-red-500 rounded-2xl w-fit p-5">
                    PENTING: Kamu hanya bisa menarik dana ketika saldo telah mencapai Rp 100.000 atau lebih
                </span>
                <div class="flex flex-row justify-between items-center">
                ...
                <h3 class="text-indigo-950 text-xl font-bold">Penarikan Dana</h3>
                <form method="POST" action="{{route('dashboard.wallet.withdraw.store')}}">
                    @csrf

                    <div>
                        <x-input-label for="bank_name" :value="__('Bank Tujuan')" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="bank_account_name" :value="__('Nama Pemilik Rekening Tujuan')" />
                    ...
                    <div class="mt-4">
                        <x-input-label for="bank_account_number" :value="__('Nomor Rekening Tujuan')" />
