...
class ProjectController extends Controller
{
    ...
    public function complete_project_store(ProjectApplicant $projectApplicant){
        ...
        DB::transaction(function() use ($projectApplicant){
            ...
            $validated['user_id'] = $projectApplicant->penjoki_id;
            $addFee = WalletTransaction::create($validated);

            $projectApplicant->penjoki->wallet->increment('balance', $projectApplicant->project->budget);
